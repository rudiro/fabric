...
e80372d2ec77        hyperledger/fabric-peer:x86_64-$ARCH-1.3.0                                                                                                         "peer node start"        About an hour ago   Up About an hour    0.0.0.0:7051->7051/tcp, 0.0.0.0:7053->7053/tcp                             peer0.org1.example.com
1326180c1c12        hyperledger/fabric-peer:x86_64-$ARCH-1.3.0                                                                                                         "peer node start"        About an hour ago   Up About an hour    0.0.0.0:8051->7051/tcp, 0.0.0.0:8053->7053/tcp                             peer1.org1.example.com
c9378eee9284        hyperledger/fabric-orderer:x86_64-$ARCH-1.3.0                                                                                                      "orderer"                About an hour ago   Up About an hour    0.0.0.0:7050->7050/tcp                                                     orderer0.example.com
...
f24b2b3c683f        hyperledger/fabric-ca:x86_64-$ARCH-1.3.0                                                                                                           "sh -c 'fabric-ca-se…"   About an hour ago   Up About an hour    0.0.0.0:7054->7054/tcp                                                     ca.org1.example.com
...
e80372d2ec77        hyperledger/fabric-peer:x86_64-$ARCH-1.3.0      "peer node start"        2 minutes ago       Up 2 minutes        0.0.0.0:7051->7051/tcp, 0.0.0.0:7053->7053/tcp                             peer0.org1.example.com
1326180c1c12        hyperledger/fabric-peer:x86_64-$ARCH-1.3.0      "peer node start"        2 minutes ago       Up 2 minutes        0.0.0.0:8051->7051/tcp, 0.0.0.0:8053->7053/tcp                             peer1.org1.example.com
c9378eee9284        hyperledger/fabric-orderer:x86_64-$ARCH-1.3.0   "orderer"                2 minutes ago       Up 2 minutes        0.0.0.0:7050->7050/tcp                                                     orderer0.example.com
...
f24b2b3c683f        hyperledger/fabric-ca:x86_64-$ARCH-1.3.0        "sh -c 'fabric-ca-se…"   2 minutes ago       Up 2 minutes        0.0.0.0:7054->7054/tcp                                                     ca.org1.example.com
