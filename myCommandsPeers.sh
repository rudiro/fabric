...
9a71084dcac5        hyperledger/fabric-orderer:x86_64-$ARCH-1.3.0                                                                                                      "orderer"                About an hour ago   Up About an hour    0.0.0.0:7050->7050/tcp                             orderer1.example.com
18e29827a615        hyperledger/fabric-peer:x86_64-$ARCH-1.3.0                                                                                                         "peer node start"        About an hour ago   Up About an hour    0.0.0.0:10051->7051/tcp, 0.0.0.0:10053->7053/tcp   peer3.org1.example.com
dc51fc223456        hyperledger/fabric-peer:x86_64-$ARCH-1.3.0                                                                                                         "peer node start"        About an hour ago   Up About an hour    0.0.0.0:9051->7051/tcp, 0.0.0.0:9053->7053/tcp     peer2.org1.example.com
...
9a71084dcac5        hyperledger/fabric-orderer:x86_64-$ARCH-1.3.0   "orderer"                10 minutes ago      Up 10 minutes       0.0.0.0:7050->7050/tcp                             orderer1.example.com
18e29827a615        hyperledger/fabric-peer:x86_64-$ARCH-1.3.0      "peer node start"        10 minutes ago      Up 10 minutes       0.0.0.0:10051->7051/tcp, 0.0.0.0:10053->7053/tcp   peer3.org1.example.com
dc51fc223456        hyperledger/fabric-peer:x86_64-$ARCH-1.3.0      "peer node start"        10 minutes ago      Up 10 minutes       0.0.0.0:9051->7051/tcp, 0.0.0.0:9053->7053/tcp     peer2.org1.example.com
